...
python chatserver.py 5005

- How to compile chatclient.c -
gcc chatclient.c -o chatclient

- How to run the chatclient.c program -
./chatclient localhost 5005

NOTE:
If port number 5005 is in use, chatserver.py will abort and display the
...
Also, always pass "localhost" to ./chatclient
